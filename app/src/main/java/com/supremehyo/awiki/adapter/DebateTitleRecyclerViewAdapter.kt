...
import com.supremehyo.awiki.databinding.DebateTitleItemRecyclerviewBinding
...
class DebateTitleRecyclerViewAdapter(activity : Activity, items: List<DebateDTO?>?, viewmodel : DebateFragmentViewModel) :
    ...
    private var  model : DebateFragmentViewModel = viewmodel
    ...
    fun updateItem(list:ArrayList<DebateDTO?>?){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == TYPE_ITEM){
            val binding = DebateTitleItemRecyclerviewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ItemViewHolder(var binding: DebateTitleItemRecyclerviewBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item: DebateDTO){
